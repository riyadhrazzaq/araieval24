...
- The output file must be named task[2][A/B/C]_any_suffix.tsv, where [1] is the task number and A/B/C is your specific subtask (for example, task2A_team_name.tsv or task2B_team_name.tsv). Failure to follow this naming convention will result in an error on the leaderboard. Subtasks include 2A, 2B and 2C.
...
**Please submit your results on test data here: https://codalab.lisn.upsaclay.fr/competitions/18099**


## List of Versions

* __Task 2 [2024/03/14]__
...
**Baseline Results for Task 1 subtasks on Dev set**
