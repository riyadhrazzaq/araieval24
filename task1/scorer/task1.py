    ...
    if subtask:
        if subtask == "task1":
            ...
            if format_pass:
                ...
                res_for_output = FLC_score_to_string(gold_annotations, user_annotations, False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gold-file", "-g", required=True, type=str,
                        default="araieval24_task1_train.jsonl",
                        help="Training file name")
    parser.add_argument("--predicted-file", "-p", required=True, type=str,
